                ...
                [
                    ...
                    'sources' => [
                        [
                            ...
                            'width' => '70',
                            'height' => '35',
                            'url' => 'http://' . $this->getConfig()->hostname . ($this->getConfig()->version ? '/' . $this->getConfig()->version : '') . '/img/brands/logos/70x35/' . $brand['medias'],
                        ],
                        [
                            'type' => '140x70',
                            'width' => '140',
                            'height' => '70',
                            'url' => 'http://' . $this->getConfig()->hostname . ($this->getConfig()->version ? '/' . $this->getConfig()->version : '') . '/img/brands/logos/140x70/' . $brand['medias'],
                        ],
                    ],
                ],
            ];
