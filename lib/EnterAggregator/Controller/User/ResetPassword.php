...
namespace EnterAggregator\Controller\User{
    ...
    class ResetPassword {
        ...
        public function execute(ResetPassword\Request $request) {
            $config = $this->getConfig();
            $curl = $this->getCurl();

            $response = new ResetPassword\Response();
...
namespace EnterAggregator\Controller\User\ResetPassword {
    use EnterModel as Model;
...
namespace EnterAggregator\Controller\User\ResetPassword\Request {
    class Config {
        /**
