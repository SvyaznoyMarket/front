...
(function (window, $, undefined) {
    ...
    $.enterslide.prototype = {
        ...
        _setCurrentValues: function () {
            ...
            this.fitCount = Math.round(this.visibleWidth / this.itemW); // количество видимых элементов списка
            this.totalPages = Math.ceil(this.itemsCount / this.fitCount);
        },
